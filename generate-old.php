        ...
        const generateBtn = document.getElementById('generateBtn');
            ...
            outfitItems.forEach(item => {
                item.addEventListener('click', () => {
                    ...
                    console.log('Selected outfit:', item.dataset.outfitPath);
                });
            });
            ...
            outfitFileInput.addEventListener('change', () => {
                ...
                // Don't hide preview - show the uploaded file instead
            });
            ...
            function validateForm() {
                ...
                // 3. Update form inputs to match selections (this is redundant now but kept for safety)
                if (selectedOutfit) {
                    const useDefaultInput = document.querySelector('input[name="use_default_outfit"]');
                    const pathInput = document.querySelector('input[name="default_outfit_path"]');
                    if (useDefaultInput) useDefaultInput.value = '1';
                    if (pathInput) pathInput.value = selectedOutfit.dataset.outfitPath;
                } else {
                    const useDefaultInput = document.querySelector('input[name="use_default_outfit"]');
                    const pathInput = document.querySelector('input[name="default_outfit_path"]');
                    if (useDefaultInput) useDefaultInput.value = '0';
