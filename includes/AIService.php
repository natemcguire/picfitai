...
class AIService {
    ...
    private function generateWithGemini(array $standingPhotos, array $outfitPhoto): array {
        ...
        This is a virtual outfit try on app.

        I will provide you with two photos. The first will be a photo of the subject (Image 1). The subject will be a human person. Pay special attention to their facial features.

        In the second photo, your job is to identify the outfit, including all accessories, and then dress the first person in the outfit you identify from the second photo.
